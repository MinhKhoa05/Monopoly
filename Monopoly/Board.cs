...
namespace Monopoly
{
    public class Board
    {
        ...
        private readonly (string name, Color color, string symbol, int? price, int? rent, bool isSpecial)[] tileConfigs =
        {
            ...
            ("SÂN BAY", Color.Red, "🛫", null, null, true),

            ("PHÚ QUỐC", Color.Red, null, 2200, 180, false),
            ("CƠ HỘI", Color.Orange, "❗", null, null, true),
            ("HẢI PHÒNG", Color.Red, null, 2200, 180, false),
            ("HỘI AN", Color.Red, null, 2400, 200, false),
            ...
            ("VÀO TÙ", Color.Red, "👮", null, null, true),
